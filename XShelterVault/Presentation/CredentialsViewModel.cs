...
{
    internal partial class CredentialsViewModel : ObservableObject
    {
        ...
        public CredentialsViewModel(IDialogManager dialogManager, IProgressBarService progressBarService, ICredentialsManager credentialsManager, IShelterVaultStateService shelterVaultStateService, /*ILanguageService languageService,*/ IWeakReferenceInstanceManager weakReferenceInstanceManager)
        {
            ...
            PasswordRequirementsVM = new PasswordConfirmationViewModel(dialogManager, "Password must:");
        ...
        public async Task<bool> DiscardChangesAsync(bool completeChallenge = false)
        {
            ...
            {
                bool discard = await _dialogManager.ShowContinueConfirmationDialogAsync(LangResourceKeys.DIALOG_CREDENTIALS_PENDING_CHANGES);
        ...
        private async Task CancelCredential()
        {
            ...
            WeakReferenceMessenger.Default.Send(new ShowPageRequestMessage(typeof(HomePage)));
        }
