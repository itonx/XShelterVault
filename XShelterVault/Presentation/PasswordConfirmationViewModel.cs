...
namespace XShelterVault.Presentation
{
    public partial class PasswordConfirmationViewModel : ObservableObject
    {
        ...
        public PasswordConfirmationViewModel(IDialogManager dialogManager, string headerText)
        {
        ...
        public async Task<bool> ArePasswordsValid(string password, string passwordConfirmation)
        {
            ...
            {
                await _dialogManager.ShowConfirmationDialogAsync("Password doesn't meet the mininum requirements.");
                return false;
            }
            else if (password != passwordConfirmation)
            {
                await _dialogManager.ShowConfirmationDialogAsync("Passwords don't match.");
                return false;
            }
